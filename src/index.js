...
bot.hears(/^(?:اشرب\s*.+|قهوة|شاي|نسكفيه|نسكافيه|كابتشينو|شاي\s*لاتيه|هوت\s*شوكليت|عصير|موهيتو|برتقال|ليمون|فواكه|موز|افوكادو|فراولة|مانجا|سفن\s*اب|سڤن\s*اب|كوكاكولا|كوكا\s*كولا|ماريندا)$/i, (ctx) => GroupGamesHandler.handleCafeConsumeCommand(ctx));
