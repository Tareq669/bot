...
bot.hears(/^مين\s*ضافني$/i, (ctx) => GroupAdminHandler.handleWhoAddedMeCommand(ctx));
...
bot.hears(/^(?:\/)?(?:مين_ضافني|مينضافني)$/i, (ctx) => GroupAdminHandler.handleWhoAddedMeCommand(ctx));
