...
bot.hears(/^(?:اشرب\s*.+|كل\s*سناك|قهوة|شاي|نسكفيه|نسكافيه|كابتشينو|شاي\s*لاتيه|عصير|موهيتو|برتقال|ليمون|فواكه|موز|سفن\s*اب|سڤن\s*اب|كوكاكولا|كوكا\s*كولا|ماريندا|سناك)$/i, (ctx) => GroupGamesHandler.handleCafeConsumeCommand(ctx));
...
bot.hears(/^\/(?:اشرب_قهوة|اشرب_شاي|اشرب_نسكفيه|اشرب_كابتشينو|اشرب_شاي_لاتيه|اشرب_عصير|اشرب_موهيتو|اشرب_برتقال|اشرب_ليمون|اشرب_فواكه|اشرب_موز|كل_سناك|drink)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleCafeConsumeCommand(ctx));
