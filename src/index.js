...
bot.hears(/^(?:اشرب\s*.+|اكل\s*.+|كول\s*.+|قهوة|شاي|نسكفيه|نسكافيه|كابتشينو|شاي\s*لاتيه|هوت\s*شوكليت|عصير|موهيتو|برتقال|ليمون|فواكه|موز|افوكادو|فراولة|مانجا|سفن\s*اب|سڤن\s*اب|كوكاكولا|كوكا\s*كولا|ماريندا|شاورما|وجبة\s*شاورما|دجاجة\s*مشوية|دجاج\s*مشوي|فروج\s*مشوي|كباب|وجبة\s*كباب|مشاوي\s*مشكل|مشاوي\s*مشكلة)$/i, (ctx) => GroupGamesHandler.handleCafeConsumeCommand(ctx));
...
bot.hears(/^(?:دين|ديني)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleReligiousMcqCommand(ctx));
bot.hears(/^(?:علمي|علوم)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleScienceMcqCommand(ctx));
bot.hears(/^(?:تاريخي|تاريخ)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleHistoryMcqCommand(ctx));
bot.hears(/^(?:فقه|فقهي)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleFiqhMcqCommand(ctx));
bot.hears(/^(?:جغرافي|جغرافيا)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleGeographyMcqCommand(ctx));
...
bot.hears(/^\/(?:اشرب_قهوة|اشرب_شاي|اشرب_نسكفيه|اشرب_كابتشينو|اشرب_شاي_لاتيه|اشرب_هوت_شوكليت|اشرب_عصير|اشرب_موهيتو|اشرب_برتقال|اشرب_ليمون|اشرب_فواكه|اشرب_موز|اشرب_افوكادو|اشرب_فراولة|اشرب_مانجا|اشرب_سفن_اب|اشرب_كوكاكولا|اشرب_ماريندا|اكل_شاورما|اكل_دجاجة_مشوية|اكل_كباب|اكل_مشاوي_مشكل|كول_شاورما|كول_كباب|كول_مشاوي_مشكل|drink|eat)(?:\s+.+)?$/i, (ctx) => GroupGamesHandler.handleCafeConsumeCommand(ctx));
