...
bot.hears(/^انضم\s*حاكم\s*جلاد$/i, (ctx) => GroupGamesHandler.handleRulerExecutionJoinCommand(ctx));
bot.hears(/^ابدأ\s*حاكم\s*جلاد$/i, (ctx) => GroupGamesHandler.handleRulerExecutionBeginCommand(ctx));
