...
const JOKE_LIBRARY = [
  'مرة واحد راح يشتري ساعة، سأل: بتجي معها وقت زيادة؟',
  'مرة واحد قال للدكتور: كل ما أشرب قهوة ما بنام، الدكتور قاله: اشربها وأنت نايم.',
  'مرة واحد اشترى ثلاجة، نام جنبها عشان ينام بارد.',
  'مرة واحد بخيل فتح مطعم، كتب: المي للفرجة فقط.',
  'مرة واحد سأل صاحبه: وينك؟ قاله: بالطريق، بس الطريق مش عارفني.',
  'مرة واحد دخل الامتحان بقلم رصاصين، قال: واحد احتياط للثاني.',
  'مرة واحد راح للحلاق قاله: قصلي تفكيرك قبل شعري.',
  'مرة واحد حب السرعة، فتح فيديو تعليمي على سرعة 3x وطلع خبير بدون ما يفهم.',
  'مرة واحد نسي كلمة السر، كتب تلميح: أنا ناسي.',
  'مرة واحد اشترى ميزان، كل يوم يوزن مزاجه.',
  'مرة واحد فتح محل عصير، أول إعلان: البرتقال معتمد من الطفش.',
  'مرة واحد قالوا له اصبر، اشترى كرسي.',
  'مرة واحد طلب بيتزا بدون جبنة، قال: أنا دايت من بعيد.',
  'مرة واحد راح البنك يسحب توتره.',
  'مرة واحد سأل GPS: كيف أوصل للنجاح؟ قاله: لف يمين واترك الأعذار.',
  'مرة واحد نام بدري، صحي متأخر عشان يكمل نومه.',
  'مرة واحد راح النادي، صور المرآة ورجع.',
  'مرة واحد سأل المعلم: في امتحان بكرا؟ قاله: حسب الحضور، قال: إذن مش جاي.',
  'مرة واحد اشترى دفتر جديد وكتب عليه: نسخة نظيفة من الفوضى.',
  'مرة واحد قال للمكيف: خف علينا، إحنا مش في القطب.',
  'مرة واحد حمل تطبيق حمية، زاد وزنه من الإعلانات.',
  'مرة واحد كتب أهداف السنة، أول هدف: ألاقي الورقة.',
  'مرة واحد تأخر عالشغل، قال: الزحمة كانت مستعجلة قبلي.',
  'مرة واحد طلب شاي بدون سكر، حط عليه شوكولاتة.',
  'مرة واحد صار شيف، كل وصفاته تبدأ بعبارة: نرتجل.',
  'مرة واحد قال لصاحبه: شو خطتك؟ قاله: مخبيها عن نفسي.',
  'مرة واحد فتح بث مباشر، ولا هو حاضر.',
  'مرة واحد نزل الجيم بكامل الحماس، رجع بحماس أكبر للجوع.',
  'مرة واحد اشترى سماعات عزل ضوضاء، سمع أفكاره وندم.',
  'مرة واحد سأل عن معنى الهدوء، قالوا له: بعد ما تسكر الإشعارات.',
  'مرة واحد كتب منشور طويل، العنوان: باختصار.',
  'مرة واحد راح ينام، المنبّه قاله: نتفاهم الصبح.',
  'مرة واحد فتح كتاب تطوير ذات، قفل على الصفحة الأولى من الإنجاز.',
  'مرة واحد سأل عن الخصم، قالوا له: ابتسم.',
  'مرة واحد اشترى قفل ذكي، نسيه برا الباب.',
  'مرة واحد دخل المطبخ يعمل دايت، طلع بوصفة كنافة.',
  'مرة واحد خطط يومه بالدقيقة، ضاعت الدقيقة الأولى.',
  'مرة واحد قال: اليوم إنتاجية، قضاه يختار أغاني.',
  'مرة واحد راح يصلح موبايله، رجع بحاجة اسمها تحديث إجبارية.',
  'مرة واحد اتصل بخدمة العملاء، اتصالح مع نفسه.',
  'مرة واحد اشترى سبورة، كتب عليها: ممنوع التأجيل غدًا.',
  'مرة واحد نسي عيد ميلاده، احتفل بإشعار البنك.',
  'مرة واحد راح المكتبة يسأل عن كتاب النجاح السريع، لقاه مستعار.',
  'مرة واحد سأل القهوة: ليش مرّة؟ قالتله: الدنيا علمتني.',
  'مرة واحد قال لأمه: بدي أطبخ، قالتله: الله يعين الحلة.',
  'مرة واحد حاول يكون رسمي، ضحكته فضحته.',
  'مرة واحد فتح مشروع، أول زبون كان صاحبه بالدين.',
  'مرة واحد كتب ملاحظة: لا تنسَ الملاحظة.',
  'مرة واحد قال: بفكر بصوت عالي، الجيران اشتكوا.',
  'مرة واحد اشترى ورد صناعي عشان يدوم، نسي يسقي الحقيقي.',
  'مرة واحد راح البحر يصيد راحة بال، رجع بصداع شمس.',
  'مرة واحد دخل محل أحذية قال: عندكم مقاس للطموح؟',
  'مرة واحد شحن بطاريته الاجتماعية، نام.',
  'مرة واحد حضر كورس طبخ، تعلم يطلب أسرع.',
  'مرة واحد كتب رسالة اعتذار لنفسه: حقك علي.',
  'مرة واحد سأل عن وظيفة أحلامه، قالوا له: نام وتعال.',
  'مرة واحد قال: ما عندي وقت، قعد يشرح ليش ما عنده وقت ساعة.',
  'مرة واحد اشترى تقويم جديد، أول يوم شطب أسبوع.',
  'مرة واحد دخل نقاش علمي، طلع بوصفة شاورما.',
  'مرة واحد قال: اليوم بلا إنترنت، استخدم كل الباقات.',
  'مرة واحد حاول يوفر، اشترى أشياء عليها تنزيل وهو مش محتاجها.',
  'مرة واحد وصل بدري، اكتشف إنه يوم العطلة.',
  'مرة واحد سأل الساعة: ليش بتركضي؟ قالتله: شغلك كثير.',
  'مرة واحد اشترى نظارة شمس، لبسها بالليل عشان الهيبة.',
  'مرة واحد عمل رجيم، جسمه قاله: نحكي بجد بعد العيد.',
  'مرة واحد قال: رايح أتمشى، رجع بكيس بطاطا.',
  'مرة واحد كتب: سري جدًا، وحطه كحالة.',
  'مرة واحد دخل المول يلف، ضاع بين العروض وطلع بقداحة.',
  'مرة واحد اشترى كتاب إدارة الوقت، أجّل قراءته.',
  'مرة واحد سأل صاحبه: كيف أهدى؟ قاله: طفي الواي فاي.',
  'مرة واحد راح يعترف بخطأه، اكتشف إنه مش فاضي اليوم.',
  'مرة واحد عمل قهوة مرة، سكرها بابتسامة.',
  'مرة واحد افتتح كافيتيريا، كتب: ممنوع الزعل مع القهوة.',
  'مرة واحد قال: اليوم بدون مصاريف، دفع توصيل مرتين.',
  'مرة واحد اشتكى من الحر، فتح الفرن بالغلط.',
  'مرة واحد حط منبّه كل 5 دقايق، وصار عنده سلسلة نوم.',
  'مرة واحد قال: بدي أتعلم إنجليزي، حفظ كلمة tomorrow واستخدمها لكل شي.',
  'مرة واحد طلب راحة نفسية، قالوا له: جرّب تسكر الإشعارات نص ساعة.',
  'مرة واحد قال: خليني مركز، وفتح 17 تبويب.',
  'مرة واحد راح يشتري لبن، رجع بسيارة لعبة.',
  'مرة واحد عمل جدول أسبوعي، نسي أي أسبوع.',
  'مرة واحد سأل: ليش الحياة صعبة؟ قالوا له: جرّب تقسمها مهام.',
  'مرة واحد اشتغل فريلانس، أول عميل كان ابن عمه بده ببلاش.',
  'مرة واحد قال: أنا دقيق، تأخر بدقيقة وثقت بنفسه أكثر.',
  'مرة واحد حب الاختصار، كتب رسالة من 4 صفحات.'
];
...
class GroupGamesHandler {
  ...
  static async handleIncomingGroupText(ctx, text) {
    ...
    if (norm === 'رسائلي') {
      const count = Number(row.messagesCount || 0).toLocaleString('en-US');
      await ctx.reply(`• عدد رسائلك هنا ~» ${count}`);
      return true;
    }
  ...
  static getNextJoke(chatId) {
    if (!Array.isArray(JOKE_LIBRARY) || !JOKE_LIBRARY.length) return 'مرة واحد قال: ما في نكت اليوم.';
    const key = `jokes:${String(chatId || 'global')}`;
    const picked = this.pickFromQueue(JOKE_LIBRARY, key) || this.pickRandom(JOKE_LIBRARY);
  ...
  static getGamesHelpPages() {
    return [
      {
        title: '🛠️ أوامر الإدارة (1/4)',
        lines: [
          '• الاوامر | /ggames',
          '• الرتب',
          '• رتبتي',
          '• فحص (بالرد/المنشن/الايدي)',
          '• all (اشارة جميع الاعضاء)',
          '• كتم / الغاء كتم',
          '• تقييد / الغاء تقييد',
          '• حظر / الغاء حظر',
          '• تحذير',
      ...
      },
      {
        ...
        lines: [
          ...
          '• استثناء المشرفين من التوجيه',
          '• استثناء المشرفين من الرسائل الطويلة',
          '• استثناء المشرفين من حماية التعديل',
